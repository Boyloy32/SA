...
const OrderList = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:8080/api/v1/orders?page=${page}&size=${pageSize}&sortDirection=desc`
    )
                ...
                {products.map((product) => (
                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">{product.customerNumber}</td>
                      <td className="px-6 py-4">{product.customerAddress}</td>
